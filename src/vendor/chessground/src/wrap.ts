...
import { createDefs, createElement as createSVG, setAttributes } from './svg';
import { type Color, colors, type Elements, files, ranks } from './types';
import { createEl, opposite, setVisible } from './util';
